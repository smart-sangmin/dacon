...
# train.py 실행
# python train.py --adam --lr 1e-3 --imgH 160 --imgW 500 --train_data /home/lab/sangminnim/train_horizontal_lmdb_dataset --valid_data /home/lab/sangminnim/val_horizontal_lmdb_dataset --manualSeed 1 --saved_model /home/lab/sangminnim/pretrained/horizontal/best_accuracy.pth --FT --batch_size 64 --num_iter 500000 --valInterval 1000 --select_data basic --batch_ratio 1.0 --batch_max_length 30 --data_filtering_off --Transformation TPS --FeatureExtraction VGG --SequenceModeling BiLSTM --Prediction Attn;
python train.py --adam --lr 1e-3 --imgH 160 --imgW 500 --train_data /home/lab/sangminnim/train_vertical_rotate_lmdb_dataset --valid_data /home/lab/sangminnim/val_vertical_rotate_lmdb_dataset --manualSeed 3 --saved_model /home/lab/sangminnim/pretrained/vertical/best_accuracy.pth --FT --batch_size 64 --num_iter 500000 --valInterval 1000 --select_data basic --batch_ratio 1.0 --batch_max_length 30 --data_filtering_off --Transformation TPS --FeatureExtraction VGG --SequenceModeling BiLSTM --Prediction Attn;
