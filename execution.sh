...
# train.py 실행
# python train.py --manualSeed 99991 --adam --lr 3e-4 --imgH 160 --imgW 500 --train_data /home/lab/sangminnim/train_horizontal_lmdb_dataset_3 --valid_data /home/lab/sangminnim/val_horizontal_lmdb_dataset --saved_model /home/lab/sangminnim/pretrained/horizontal/maybe_super_best_h.pth --FT --batch_size 32 --num_iter 100000 --valInterval 1000 --select_data basic --batch_ratio 1.0 --batch_max_length 30 --data_filtering_off --Transformation TPS --FeatureExtraction VGG --SequenceModeling BiLSTM --Prediction Attn;
python train.py --manualSeed 99992 --adam --lr 3e-4 --imgH 160 --imgW 500 --train_data /home/lab/sangminnim/train_vertical_rotate_lmdb_dataset_3 --valid_data /home/lab/sangminnim/val_vertical_rotate_lmdb_dataset --saved_model /home/lab/sangminnim/pretrained/vertical/maybe_super_best_v.pth --FT --batch_size 32 --num_iter 50000 --valInterval 1000 --select_data basic --batch_ratio 1.0 --batch_max_length 30 --data_filtering_off --Transformation TPS --FeatureExtraction VGG --SequenceModeling BiLSTM --Prediction Attn;
