...
# train.py 실행
python train.py --imgH 160 --imgW 500 --train_data /data-1/lab/sangminnim/train_horizontal_lmdb_dataset --valid_data /data-1/lab/sangminnim/val_horizontal_lmdb_dataset --manualSeed 1 --saved_model saved_models/TPS-VGG-BiLSTM-Attn-Seed1/best_accuracy.pth --FT --batch_size 16 --num_iter 300000 --valInterval 1000 --select_data basic --batch_ratio 1.0 --batch_max_length 30 --data_filtering_off --Transformation TPS --FeatureExtraction VGG --SequenceModeling BiLSTM --Prediction Attn;
python train.py --imgH 160 --imgW 500 --train_data /data-1/lab/sangminnim/train_vertical_rotate_lmdb_dataset --valid_data /data-1/lab/sangminnim/val_vertical_rotate_lmdb_dataset --manualSeed 2 --saved_model saved_models/TPS-VGG-BiLSTM-Attn-Seed2/best_accuracy.pth --FT --batch_size 16 --num_iter 100000 --valInterval 1000 --select_data basic --batch_ratio 1.0 --batch_max_length 30 --data_filtering_off --Transformation TPS --FeatureExtraction VGG --SequenceModeling BiLSTM --Prediction Attn;
