...
def validation(model, criterion, evaluation_loader, converter, opt):
    ...
    # horizontal = pd.read_csv('./data/test_horizontal.csv')
    # horizontal['text'] = words
    # horizontal.to_csv('./horizontal.csv', index=False, encoding="utf-8-sig")

    # vertical = pd.read_csv('./data/test_vertical.csv')
    # vertical['text'] = words
    # horizontal = pd.read_csv('./horizontal.csv')
    # merged = horizontal.append(vertical, sort='img_path')
